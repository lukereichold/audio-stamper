...
///
- (nonnull instancetype)init:(AKNode * _Nullable)input masterVolume:(double)masterVolume pitchBend:(double)pitchBend vibratoDepth:(double)vibratoDepth filterCutoff:(double)filterCutoff filterEgStrength:(double)filterEgStrength filterResonance:(double)filterResonance attackDuration:(double)attackDuration decayDuration:(double)decayDuration sustainLevel:(double)sustainLevel releaseDuration:(double)releaseDuration filterEnable:(BOOL)filterEnable filterAttackDuration:(double)filterAttackDuration filterDecayDuration:(double)filterDecayDuration filterSustainLevel:(double)filterSustainLevel filterReleaseDuration:(double)filterReleaseDuration OBJC_DESIGNATED_INITIALIZER;
- (void)playWithNoteNumber:(uint8_t)noteNumber velocity:(uint8_t)velocity frequency:(double)frequency;
- (void)stopWithNoteNumber:(uint8_t)noteNumber;
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_DEPRECATED_MSG("-init is unavailable");
...
typedef SWIFT_ENUM(NSInteger, RampType) {
  RampTypeLinear = 0,
